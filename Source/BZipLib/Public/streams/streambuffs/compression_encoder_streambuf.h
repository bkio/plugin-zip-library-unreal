...
class compression_encoder_streambuf : public std::basic_streambuf<ELEM_TYPE, TRAITS_TYPE>
{
public:
	...
	typedef TSharedPtr<icompression_encoder_type>                  icompression_encoder_ptr_type;
