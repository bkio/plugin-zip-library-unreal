...
class compression_decoder_streambuf : public std::basic_streambuf<ELEM_TYPE, TRAITS_TYPE>
{
public:
	...
	typedef TSharedPtr<icompression_decoder_type>                  icompression_decoder_ptr_type;
