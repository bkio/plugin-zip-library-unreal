...
struct compression_encoder_properties_interface : compression_properties_interface
{
	template <typename T>
...
struct compression_decoder_properties_interface : compression_properties_interface
{
...
template <typename ELEM_TYPE, typename TRAITS_TYPE>
class compression_encoder_interface_basic : public compression_interface_basic<ELEM_TYPE, TRAITS_TYPE>
{
public:
...
template <typename ELEM_TYPE, typename TRAITS_TYPE>
class compression_decoder_interface_basic : public compression_interface_basic<ELEM_TYPE, TRAITS_TYPE>
{
public:
	typedef typename compression_interface_basic<ELEM_TYPE, TRAITS_TYPE>::istream_type istream_type;
	typedef typename compression_interface_basic<ELEM_TYPE, TRAITS_TYPE>::ostream_type ostream_type;
